...
#include "obj_dir_FFTSPIInterconnectRTL/VFFTSPIInterconnectRTL.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_FFTSPIInterconnectRTL/VFFTSPIInterconnectRTL__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void trace( VFFTSPIInterconnectRTL_t *, char * );
  #endif
...
VFFTSPIInterconnectRTL_t * create_model( const char *vcd_filename ) {

  VFFTSPIInterconnectRTL_t * m;
  VFFTSPIInterconnectRTL   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VFFTSPIInterconnectRTL_t *) malloc( sizeof(VFFTSPIInterconnectRTL_t) );
  model = new VFFTSPIInterconnectRTL();
...
void destroy_model( VFFTSPIInterconnectRTL_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VFFTSPIInterconnectRTL * model = (VFFTSPIInterconnectRTL *) m->model;
...
void comb_eval( VFFTSPIInterconnectRTL_t * m ) {
...
void seq_eval( VFFTSPIInterconnectRTL_t * m ) {
...
#if VLINETRACE
void trace( VFFTSPIInterconnectRTL_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_FFTSPIInterconnectRTL__v );
