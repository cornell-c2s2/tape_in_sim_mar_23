...
class TwiddleGeneratorTestHarnessVRTL( VerilogPlaceholder, Component ):
  ...
  def construct( s, BIT_WIDTH   = 4, DECIMAL_PT  = 1, SIZE_FFT    = 8, STAGE_FFT   = 0):
    ...
    s.set_metadata( VerilogTranslationPass.explicit_module_name, 'TwiddleGenerator' )
...
# Import the appropriate version based on the rtl_language variable
  ...
  xbar = TwiddleGeneratorTestHarnessVRTL
else:
